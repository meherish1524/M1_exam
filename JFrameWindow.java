...
public class JFrameWindow {
    ...
    JFrameWindow(int width, int height) {
        ...
        frame = new JFrame();
        mYesButton = new JButton("Fail");
      
        mNoButton = new JButton("Pass");
        
        mTextField = new JTextField("M1 Result ?");
        ...
        mNoButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
            	count=count+1;
            	//mNoButton.setText(count+" attempt");
            	mTextField.setText("Are u Kidding 😆😆 ?");
